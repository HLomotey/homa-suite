                ...
                <div key={category} className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <div 
                      ...
                      style={{ 
                        '--category-color': `hsl(${(index * 360) / sortedCategories.length}, 70%, 50%)`,
                ...
                <div key={company} className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <div 
                      className="w-3 h-3 rounded-full"
                      style={{ 
                        '--company-color': `hsl(${30 + (index * 360) / sortedCompanies.length}, 70%, 50%)`,
              ...
              <div key={type} className="bg-yellow-900/10 p-4 rounded-lg border border-yellow-800/30">
                ...
                <div className="mt-2 bg-yellow-800/20 rounded-full h-2">
                  <div 
                    ...
                    style={{ 
                      '--progress-width': `${getPercentage(total, analytics.totalExpenses)}%`,
