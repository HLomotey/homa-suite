...
export function EthnicityBreakdown({ timeRange = "6m", department = "all" }: EthnicityBreakdownProps) {
  const { ethnicityData, loading } = useDiversityAnalytics(timeRange, department);
