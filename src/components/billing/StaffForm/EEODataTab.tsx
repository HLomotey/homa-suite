  ...
  return (
    <>
      <div className="text-sm text-muted-foreground mb-4">
        Equal Employment Opportunity data is collected for compliance purposes
        and is optional.
      </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Select
            name="ethnicityRace"
            defaultValue={staff?.ethnicityRace || ""}
          >
            <SelectTrigger>
        ...
        <div className="space-y-2">
          ...
          <Select
            name="veteranStatus"
            defaultValue={staff?.veteranStatus || ""}
          >
            <SelectTrigger>
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            defaultValue={staff?.disabilityStatus || ""}
          >
            <SelectTrigger>
