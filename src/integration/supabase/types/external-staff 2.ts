...
// History External Staff - identical structure to ExternalStaff
export interface HistoryExternalStaff {
  id: string;
  "PAYROLL LAST NAME": string | null;
  "PAYROLL FIRST NAME": string | null;
  "PAYROLL MIDDLE NAME": string | null;
...
export interface CreateHistoryExternalStaff extends Omit<HistoryExternalStaff, "id" | "created_at" | "updated_at"> {}

export interface UpdateHistoryExternalStaff extends Partial<Omit<HistoryExternalStaff, "id" | "created_at">> {}

// Use the same interface for frontend to eliminate mapping complexity
export type FrontendExternalStaff = ExternalStaff;
export type FrontendHistoryExternalStaff = HistoryExternalStaff;
