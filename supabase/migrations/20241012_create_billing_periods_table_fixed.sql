-- Create billing periods table for standardized billing cycles (FIXED VERSION)
...
CREATE INDEX idx_billing_periods_period_type ON billing_periods(period_type);
CREATE INDEX idx_billing_periods_is_active ON billing_periods(is_active);
